...
<asp:Content ContentPlaceHolderId="PlaceHolderAdditionalPageHead" runat="server">
	...
	<link rel="stylesheet" type="text/css" href="../SiteAssets/css/dataTables.css" />
	...
	<script src="../SiteAssets/js/dataTables.js"></script>
	<script src="../SiteAssets/js/Util.js"></script>
	<script src="../SiteAssets/js/ConsultaTicketsProcessManager.js"></script>
	<script>
...
<asp:Content ContentPlaceHolderId="PlaceHolderMain" runat="server">
	...
	<div class="container" style="display: block;margin-top: 30px;width: 1110px;text-align: center;background-color: white;padding: 10px;margin-left: auto;margin-right: auto;">
		<div id="dvLoading" class="spinner-border text-primary" role="status">
			<span class="sr-only">Loading...</span>
		</div>
		<h2>Process Manager</h2>

		<table id="tbCodigos_WP" class="display" cellspacing="0" width="100%" style="display: none;">
	...
	<div style="overflow-x: auto; max-width: 100%;">
	<div class="container" style="display: block;margin-top: 30px;width: 1110px;text-align: center;background-color: white;padding: 10px;margin-left: auto;margin-right: auto;">
		<div id="dvLoadinGrupos" class="spinner-border text-primary" role="status">
			<span class="sr-only">Loading...</span>
		</div>
		<h2>Colaboradores</h2>
		<table id="tbGrupos_WP" class="display " cellspacing="0" width="100%" style="display: none;">
			<thead style="text-align: center;">
				<tr>
					<th>Folio</th>
          			<th>Ticket</th>
