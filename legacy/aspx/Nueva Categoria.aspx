<%-- _lcid="3082" _version="16.0.19520" _dal="1" --%>
	...
	<script src="path/to/jquery.multiselect.js"></script>-->
									...
									<script src="../SiteAssets/js/NuevaCategoria.js"></script>
									...
									<div class="container"
										...
										<div id="dvHeadForm" class="form-row">
											<div class="form-group col-md-8">
												<h5 style="margin-top: 35px;text-align: center;">Nueva Categoría</h5>
											</div>
			...
			<input type="text" class="form-control" id="txtIdRegistro" placeholder="Folio de registro" disabled="disabled" title="Folio de registro de la solicitud"/>-->
										...
										<div class="form-row">
											<div class="form-group col-md-4">
												...
												<input type="text" class="form-control is-invalid" id="txtCategoria"
													data-id="" />
											</div>
											<div class="form-group col-md-4">
											...
											<div class="form-group col-md-4">
												...
												<select name="cmbTipoCat" id="cmbTipoCat"
													class="form-control is-invalid">
													<option value="none" selected disabled>Seleccione una opción
													</option>
										...
										<div class="form-row">
											<div class="form-group col-md-4">
												...
												<select name="cmbCatPadre" id="cmbCatPadre" class="form-control ">
												</select>
											</div>
											<div class="form-group col-md-4">
											...
											<div class="form-group col-md-4">
												<label for="LblGrupos">Grupos permitidos:</label>
												<select name="CmbGrupos" id="CmbGrupos" class="form-control  is-invalid"
													multiple></select>
											</div>
										</div>
										<div class="row">
											<div class="form-group col-md-3">
												...
												<input type="number" class="form-control is-invalid" id="txtSLALow" data-id="" step="1" min="1" />
											</div>
											<div class="form-group col-md-3">
												<label for="txtSLAMedium">SLA Medium (hours):</label>
												<input type="number" class="form-control is-invalid" id="txtSLAMedium" data-id="" step="1" min="1" />
											</div>
											<div class="form-group col-md-3">
												<label for="txtSLAHigh">SLA High (hours):</label>
												<input type="number" class="form-control is-invalid" id="txtSLAHigh" data-id="" step="1" min="1" />
											</div>
											<div class="form-group col-md-3">
												<label for="txtSLAStopProduction">Stop Production (hours):</label>
												<input type="number" class="form-control is-invalid" id="txtSLAStopProduction" data-id="" step="1" min="1" />
											</div>
										</div>
										<div class="form-row">
										...
										<div class="form-row">
											<div class="form-group col-md-12">
												...
												<textarea type="text" class="form-control is-invalid"
													id="txtProcedimientos" data-id=""></textarea>
												</select>
											</div>
										</div>
									...
									<div class="form-row">
										...
										<div class="form-group col-md-4" style="text-align: right;">
											<button type="button" class="btn btn-primary"
												id="btnEnviarReporte">Enviar</button>
