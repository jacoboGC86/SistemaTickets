...
<asp:Content ContentPlaceHolderId="PlaceHolderAdditionalPageHead" runat="server">
	...
	<script src="../SiteAssets/js/DetalleDeTemplate.js"></script>
	...
	<div class="container" style="margin-top: 20px;min-height: 600px; background-color: white;">
		<div id="dvHeadForm" class="form-row">	
			<div class="form-group col-md-8">
				<h5 style="margin-top: 35px;text-align: center;">Detalle de la plantilla</h5>
			</div>
		...
		<div class="form-row">	
			<div class="form-group col-md-6">
				...
				<input type="text" class="form-control is-valid" id="txtNameTemplate" data-id="" disabled  />
			</div>
			<div class="form-group col-md-4">
			</div>
		...
		<div class="form-row">	
			<div class="form-group col-md-12">
				...
				<textarea id="txtDescripcion" class="form-control is-valid" disabled ></textarea>
			</div>
		</div>
		<div class="form-row" >
			<div class="form-group col-md-4">
				<label for="cmbManager">Gerente de proceso Puebla</label>
				<select name="cmbManager" id="cmbManager" class="form-control is-valid" disabled></select>
			...
			<div class="form-group col-md-4">
				...
				<select name="cmbManagerAguascalientes" id="cmbManagerAguascalientes" class="form-control is-valid" disabled></select>
			</div>
		</div>
		<div class="form-row" >
			<div class="form-group col-md-12">
				...
				<div class="tab-content" id="myTabContent">
							...
							<div class="form-group col-md-4">
								...
								<ul class="list-group" id="ulGruposDisponibles">
									<li class="list-group-item">
										<a href="#" class="addGpo" data-approvalgroup="null"  aria-disabled="true" style="pointer-events: none; color: gray;"data-nombre="Revisión de Manager" data-useuserdepartment="true">Agregar</a> 
										Revisión de Manager
									</li>
								</ul>
							</div>
					...
					<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
						<div class="form-row" >
							<div class="form-group col-md-4">
								<h5>Controles</h5>
								<ul class="list-group" id="controlList">
									<li class="list-group-item">
										<a href="#" class="addControl" data-tag="h3" aria-disabled="true" style="pointer-events: none; color: gray;">Agregar</a> Título
									</li>
									<li class="list-group-item">
										<a href="#" class="addControl" data-tag="p" aria-disabled="true" style="pointer-events: none; color: gray;">Agregar</a> Párrafo
									</li>
									<li class="list-group-item">
										<a href="#" class="addControl" data-tag="br" aria-disabled="true" style="pointer-events: none; color: gray;">Agregar</a> Espacio
									</li>
									<li class="list-group-item">
										<a href="#" class="addControl" data-tag="textarea" aria-disabled="true" style="pointer-events: none; color: gray;">Agregar</a> Caja de texto
									</li>
									<li class="list-group-item">
										<a href="#" class="addControl" data-tag="checkbox" aria-disabled="true" style="pointer-events: none; color: gray;">Agregar</a> Checkbox
									</li>
								</ul>
							</div>
