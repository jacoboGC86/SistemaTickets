...
$(document).ready(function () {
    ...
    $("#DeltaPlaceHolderPageTitleInTitleArea a").text("Tickets asignados a aprobadores");
    ...
    context.executeQueryAsync(function () {
        ...
        context.executeQueryAsync(function () {
          ...
          //  console.log("Estos son los grupos",Grupos, "al que pertenece",cuserId);
            ...
            context.load(ticketsItems, 'Include(Id, Title, TipoTicket, Manager, Categoria, Categoria_x003a_SLALow, Categoria_x003a_SLAMedium, Categoria_x003a_SLAHigh, Prioridad, Status, Modified, ProcessManager, TemplateConfiguracion,Author)');
            ...
            context.executeQueryAsync(function () {
                ...
                while (ticketEnumerator.moveNext()) {
                    ...
                    try {
                            ...
                            var perteneceAGrupo = Grupos.includes(Status);
                            
                            // status es igual a Revisión de Manager?
                            var requiereManager = Status === ("Revisión de Manager");
                            
                            // ¿el manager es igual al usuario que inicia sesión?
