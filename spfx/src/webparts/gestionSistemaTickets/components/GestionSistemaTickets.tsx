...
import type { IGestionSistemaTicketsProps } from './IGestionSistemaTicketsProps';
import { escape } from '@microsoft/sp-lodash-subset';

export default class GestionSistemaTickets extends React.Component<IGestionSistemaTicketsProps> {
